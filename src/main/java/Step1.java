...
public class Step1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Next three lines are for running on local machine
//        job.setInputFormatClass(TextInputFormat.class); // Example File - 3_grams.txt
...
//        FileOutputFormat.setOutputPath(job, new Path("/home/spl211/IdeaProjects/MapReduceProject/output_step_1")); // For running on local machine
        FileOutputFormat.setOutputPath(job, new Path("s3://bucket163897429777/output_step_1"));
