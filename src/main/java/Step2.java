...
//        FileInputFormat.addInputPath(job, new Path("/home/spl211/IdeaProjects/MapReduceProject/output_step_1/part-r-00000")); // For running on local machine
        FileInputFormat.addInputPath(job, new Path("s3://bucket163897429777/output_step_1"));
//        FileOutputFormat.setOutputPath(job, new Path("/home/spl211/IdeaProjects/MapReduceProject/output_step_2"));
        FileOutputFormat.setOutputPath(job, new Path("s3://bucket163897429777/output_step_2")); // For running on local machine
